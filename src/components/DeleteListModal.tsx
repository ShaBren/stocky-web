...
export function DeleteListModal({ isOpen, onClose, list }: DeleteListModalProps) {
                  ...
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">
                        Are you sure you want to delete "{list?.name}"? This action cannot be undone and will also remove all items in this list.
                      </p>
                    </div>
                  </div>
                </div>
